    ...
    return {
        ...
        */
        ...
        getState: function (index) {
            ...
            return this.history[index] || this.ideal;
        },
        ...
        */
        ...
        getLastIdealIndex: function (index) {
            ...
            while (index >= 0) {
                if (this.history[index] === this.ideal) {
                    return index;
                }
                index = index - 1;
            }
        ...
        */
        ...
        triggerAction: function (index) {
            ...
            /*
                If we are not ideal then set the state of all connected
                synapses to the values used last time we were ideal.
            */
            ...
            if (this.getState() === 1 && this.synapses.length) {
                ...
                */
                ...
                /*
                    ...
                    If not then go back in time and ask again (we do this because of the recursion).
                */

                if (this.getState(index) !== this.ideal) {
                ...
                */
                ...
                /*
                    Idea: Store the index used for a quick look up later.
                */
